...
// !======Radio Linsk===========
document.addEventListener('DOMContentLoaded', function () {
    const radioCustom = document.querySelectorAll('.custom-radio');
    ...
    const organizationLink = 'http://system5.dev/org';
    const personalLink = 'http://system5.dev/personal';
    ...
    nextButton.addEventListener('click', function (e) {
        ...
        if (selectedOption !== null) {
            ...
            radioCustom.forEach((el) => {
                el.style.border = '1px solid rgba(255, 0, 0, 0.30)';
            });
        }
    });
});
